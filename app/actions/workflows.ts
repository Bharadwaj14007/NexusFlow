...
export const workflowExecutionSummaryAction = action(service.workflowExecutionSummary)
export const replayWorkflowExecutionAction = action(service.replayWorkflowExecution)
export const cancelWorkflowExecutionAction = action(service.cancelWorkflowExecution)
